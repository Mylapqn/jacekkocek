...
function searchYoutube(argument) {
  return new Promise((resolve, reject) => {
    Https.get("https://youtube.googleapis.com/youtube/v3/search?part=snippet&eventType=completed&maxResults=1&q=" + argument + "&regionCode=US&relevanceLanguage=EN&key=" + process.env.SEARCH_API_KEY, function (res) {
      console.log("HTTPS Status:" + res.statusCode);
      var body;
      res.on("data", function (data) {
        body += data;
