      ...
      switch (command) {
        ...
        case "kino":
          ...
          message.channel.send("Bude **" + argument + "**?").then((m) => {
            ...
            m.react("767903375927803944");
            m.react("767903376477257779");
            m.react("767903376968122388");
            m.react("767903374888534046");
            m.react("767903375659368468");
            m.react("767903377018322964");
            m.react("767903374988541984");
            m.react("❌");
          });
